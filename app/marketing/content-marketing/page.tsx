			...
			<div className="bg-gradient-to-r from-orange-50 to-red-50 py-8 md:py-16">
				<div className="container mx-auto px-4 max-w-4xl">
					...
					<p className="text-base md:text-lg text-gray-600 leading-relaxed md:leading-relaxed text-center max-w-2xl mx-auto">
						Discover the latest insights, trends, and strategies in content marketing, SEO, and
						business growth.
					</p>
				</div>
			</div>

			<div className="gap-10 container mt-10">
				<div className="flex flex-col mb-10 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-2 md:p-6 space-y-6">
					<div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
						<div className="space-y-8 w-full lg:w-11/12 ">
							...
							<h1 className="font-bold text-2xl italic">
								Let Us Give Voice to Your Untold & Undersold Stories
							</h1>
							<p>
								Did you know content is one of the most important factors that make your website
								rank? Well, a study shows that the conversion rate is nearly 6 times higher for
								companies that utilize content marketing best practices versus non-adopters.
							</p>
							<p>
								We understand a comprehensive{' '}
								<span className="font-bold">content marketing strategy</span> is important for
								building brand authority, brand awareness, and lead generation.
							</p>
							<p>So, let us build your online presence, and you do what you do best.</p>
							<p>
								From Fortune 500 brands to mid-sized and small startups, we are comfortable working
					...
					<p>
						All we care about is your passion and dedication towards building your brand! So, are
						you ready to stand out and leave your competitors behind? Give us a call right away!
					</p>
				</div>
				...
				<div className="flex flex-col bg-blue-50 p-2 md:p-6 space-y-6">
					<div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
						...
						<div className="space-y-8 w-full lg:w-11/12 mt-14">
							...
							<p>
								Content marketing tells a story itself. And, as humans, we give out attention to
								those who tell great and compelling stories. This is why; we follow a strategic
								marketing approach by creating and distributing relevant and unique content among
								your target audience.
							</p>
							<p>
								With appropriate content to retain a clearly-defined audience, we make sure to drive
								profitable user action. By working alongside project managers and strategists, our
								industry-focused writers make sure to craft a piece keeping the content marketing
								techniques in mind.
							</p>
							<p>
								On top of that, our professional writers combine their excellent writing skills with
								the best SEO practices to make sure the content fulfills Google’s guidelines. For
								this, we map out the content to make sure the keywords, title, topic, and formatting
								hold enough power to keep your readers engaged. This way, we will also help you
						...
						<div className="flex flex-col w-full items-center text-center gap-4">
							<div className="text-white bg-red-600 w-20 h-20 justify-center items-center rounded-full font-bold">
								<Image
									src={IconIMG1}
									alt="IconIMG1"
									className="w-10 h-10 justify-center items-center m-5"
								/>
							</div>
				...
				<div className="flex flex-col space-y-6">
					<div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
						<div className="space-y-8 w-full lg:w-11/12 mt-8">
							<p>
								The words web and log combine to from WebLog! This is an excellent service and a
								tool for marketing to reach your target audience and potential customers for your
								home businesses. These are easy to manage, integrate, and accessible with the
								upcoming blogging platforms.
							</p>
							<p>
								It is really amusing to see how businesses take leads and become famous through
								blogging.
							</p>
							<p>
								Well, some people associate it with being time-consuming and believing that you
								always need to be on your toes with creative ideas. However, their pro outnumbers
								the cons. Blog marketing is:
							</p>
				...
				<div className="flex flex-col bg-blue-50 space-y-6">
					<div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
						...
						<div className="space-y-8 w-full lg:w-11/12 mt-14">
							<p>
								Ever since marketing gained importance, the importance of info graphics was at par
								with other forms of content marketing. These are not just visual representations
								that are more presentable and appealing that just big chunks of text. They are a
								competitive tool for web marketing- either can make or break your game.
							</p>
							<p>
								That said, it is crucial to be able to convey the same information as through text.
							</p>
							<p>
								This content marketing service engages more market than a just usual written piece,
								which possibly explains the reason why infographics gained recognition. More and
								more businesses are using this tool to boost their marketing campaigns and racing to
								the top. This helps you to be more dynamic, visually-appealing and makes you stand
								out from your competition.
							</p>
							<p>
								So it is always advisable to be search friendly, use info graphics, SEO, and links
								in your content.
							</p>
						</div>
					</div>
				...
				<div className="flex flex-col space-y-6">
					<div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
						<div className="space-y-8 w-full lg:w-11/12 mt-14">
							<p>
								Content marketing offers various media options, ranging from blog posts, articles,
								infographics, as mentioned above.
							</p>
							<p>
								Website content is the central hub for marketing efforts. The links to your
								newsletters should always include links to your website. The blogs you post on
								social media should redirect your readers to your website. Hence, it is regarded as
								the central hub.
							</p>
							<p>
								Your website should true reflection of your work and not just copy-paste. So, it
								should be 100% original, SEO friendly, and surfing through your webpage should be a
								seamless experience.
							</p>
							<p>
								Website content is a passive nurturing, too, since you cannot be available around
								the clock to hold all prospects and queries through the sale process.
							</p>
						</div>
				...
				<div className="flex flex-col bg-blue-50 space-y-6">
					<div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
						...
						<div className="space-y-8 w-full lg:w-11/12 mt-14">
							<p>
								This is a priority for a successful business, and{' '}
								<Link href="/email-marketing" className="text-blue-600">
									choosing the right email marketing
								</Link>{' '}
								has a great impact on the overall success of your marketing campaigns. And as a sigh
								a relief for you, we are best at this service. We frame a bespoke email newsletter,
								which can re-frame your market reach out.
							</p>
							<p>
								This tool is highly cost-effective for small businesses as well with high ROI
								(return on investment). Moreover, these are easy to manage, controllable, and direct
								contact methods.
							</p>
						</div>
					</div>
				...
				<div className="flex flex-col space-y-6">
					<div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
						<div className="space-y-8 w-full lg:w-11/12 mt-14">
							<p>Nowadays, brand trust is important in the commercial battlefield.</p>
							<p>
								Ebooks have an upper edge over other services like blog posts and YouTube videos
								that the former are downloadable, which offers it more real value. So it is
								no-brainer that Neil Patel- the digital marketing expert planned ebooks on the
								second slot in his list to create lead-generating content.
							</p>
							<p>
								Ebooks offer you the chance to showcase higher authority and ability on a subject
								with greater depth when compared to what blog posts offer. Therefore, it is rightly
								said that this service will play a vital role in content marketing and bring more
								traffic.
							</p>
						</div>
				...
				<div className="flex flex-col bg-blue-50 space-y-6">
					<div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
						...
						<div className="space-y-8 w-full lg:w-11/12 mt-14">
							<p>
								Case studies are a vital part of the content marketing toolkit. It upholds the whole
								marketing industry.
							</p>
							<p>
								So, we present you these examples to prove how effective case studies help in
								marketing:
							</p>
							<p>
								Case study 1: LENOVO: They had a sound content marketing plan as they developed a
								digital content hub as the “tech revolution” expanded to successfully engage its
								potential market.
							</p>
							<p>
								Case study 2: SAP: This behemoth, one the leading vendor of ERP software serving
								various organizations around the globe, reached out to its customer segments through
								developing a comprehensive content plan to show thought leadership
							</p>
						</div>
					</div>
				</div>
				...
				<div className="flex flex-col space-y-6">
					<div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
						<div className="space-y-8 w-full lg:w-11/12 mt-14">
							<p>
								Living in this fast-paced world gives rise to the need for finding and creating
								unique ways to make your brand stand out. Using compelling video content for
								marketing is a versatile tactic that marketers can leverage. From long and short
								formats to promotional and influential videos, we know visuals can help you achieve
								a more satisfying relationship with your audience.
							</p>
							<p>Here is how videos can benefit your brand:</p>
							<ul className="list-disc pl-6 space-y-2">
				...
				<div className="flex flex-col bg-blue-50 space-y-6">
					<div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
						...
						<div className="space-y-8 w-full lg:w-11/12 mt-14">
							<p>
								Social Media is undoubtedly the best way to connect with your audience. With more
								and more people starting to use social media platforms, it is always a good idea to
								leverage this medium to increase your online presence. Along with posting engaging
								content, the quality of content also plays an important role in marketing.
							</p>
							<p>
								This is where we enter. We will create magnetic social media content that will not
								only promote your brand but also stimulate user’s interests in your services and
								products.
							</p>
							<p>Social media can help you in these various ways:</p>
				...
				<div className="gap-20  mt-10">
					<div className="flex flex-col rounded-lg shadow-lg my-10 hover:shadow-xl transition-shadow duration-300 p-2 md:p-6  space-y-6">
						<div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
							<div className="space-y-8 w-full lg:w-11/12 mt-14">
								<h1 className="font-bold text-4xl">Why Content Marketing?</h1>
								<ul className="list-decimal pl-6 space-y-2">
									...
									<li>
										58% of marketers believe original content is the most important type of content.
									</li>
					...
					<div className="flex flex-col bg-blue-50 space-y-6">
						<div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
							...
							<div className="space-y-8 w-full lg:w-11/12 mt-14">
								...
								<p>
									We are a team of content marketing experts who believe in quality over quantity.
									By delivering the top-notch content, we succeed in increasing your website’s
				...
				<h1 className="text-3xl flex justify-center items-center mt-10 rounded-lg shadow-lg my-10 hover:shadow-xl transition-shadow duration-300 p-2 md:p-6  font-bold">
					For this, we will do:
				</h1>
				<div className="grid pt-10 grid-cols-1 sm:grid-cols-2 bg-blue-50 p-6 md:grid-cols-1 lg:grid-cols-3 mt-8 gap-10 sm:gap-16 lg:gap-20">
					<div className="flex flex-col w-full items-center text-center gap-4">
						...
						<p>
							By researching and analyzing your competitor’s content strategy, we make sure you are
					...
					<div className="flex flex-col w-full items-center text-center gap-4">
						...
						<p>
							We will analyze your target audience and their interaction to deliver you the right
							content, which catches their attention.
						</p>
					</div>
					...
					<div className="flex flex-col w-full items-center text-center gap-4">
						...
						<p>
							We create content that is specially customized according to your needs to give you the
							results you want. Not only will it increase your site’s traffic but also increase your
							click-through rates.
						</p>
					</div>
				</div>
				...
				<div className="mt-20">
					<h1 className="italic font-bold text-3xl">
						Our team continues to provide its services without any interruption as the world
