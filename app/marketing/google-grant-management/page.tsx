    ...
    return (
      ...
      <div className="flex flex-col mb-10 space-y-6 justify-start">
          ...
          <div className="space-y-6">
            <p>
            Do you manage a nonprofit organization but want to make the most of your<Link href='/' className='text-blue-500'> digital marketing initiatives?</Link>
            </p>
            <p>
        ...
        <div className="flex flex-col mb-10 space-y-6 justify-start">
          ...
          <div className="space-y-6">
            ...
            <p>
            Just enlighten us on your goals and objectives, and leave it to the EXPERTS! We make <span className='font-bold'>Google Ad Grant Management</span> simple. 
            </p>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            What is included in Google Grant Management? Here is the list! 
                 ...
                 <ul className='list-decimal pl-5 space-y-2'>
                            ...
                            <li> You must gain approval through the process of Ad Grants pre-qualification after you have enrolled in Google for Nonprofits.</li>
                        </ul>
                 <p>
        ...
        <div className="flex flex-col mb-10 space-y-6 justify-start">
          ...
          <div className="space-y-6">
            ...
            <p>We have various plans for you, specially tailored according to your needs so that you can stay agile and flexible.</p> 

            

            <li className='font-bold'>We Have Dedicated Customer Support </li> 
            <p>With us, you have easy access to your personal Grant Manager via email round the clock. Also, we make regular check-in calls and keep you in loops regarding the progress of your campaigns.</p>

            <li className='font-bold'>We Can Create Unlimited Campaigns </li> 
            <p>With Prime Marketing Experts, you don’t have to worry about the number of your campaigns. If you need, we will create unlimited ad groups and campaigns to help you reach the maximum audience.</p>

            <li className='font-bold'>We Develop Compelling Ads</li> 
            <p>Yes, we can create engaging ads for your organization to get you the highest possible CTR (Click through rate) and bring traffic to your landing pages.</p> 

            <li className='font-bold'>We Create Amazing Landing Pages </li> 
            <p>Is your landing page not enough? Is it not getting the desired clicks? Well, leave it to us, and we will help you create a click-worthy landing page that can abet you get the most out of your campaign potential.</p>

            <li className='font-bold'>We Assess The Performance Of Your Google Grant Campaign</li> 
            <p>We track your account’s success by measuring a number of metrics. We will measure your campaign’s performance and improve your strategy to get the best results.</p>
             </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col  space-y-6 justify-start">
          ...
          <div className="space-y-6">
            ...
            <ul className="list-disc pl-5 space-y-6">
              <li><span className='font-bold'>CTR:</span>It’s unmistakably imperative to know how many people are really clicking on your ads. Assessing your CTR (Click-Through-Rate) can help you figure out which of your keywords and ads are generally relevant to your audience and prompt them to click on it. We also use CTR to see which ad copy drives the most outcomes.</li>
              <li><span className='font-bold'>Keyword Quality Score:</span> You can determine the quality of your keywords using Google’s quality score of 1 to 10. If your keywords are not ranking above 4, you must change your keywords or find a great strategy to optimize them. </li>
              <li><span className='font-bold'>Impressions:</span> On the off chance that your keywords are excessively explicit, you risk passing up search traffic. So, you should analyze your keywords to see which ones have the lowest number of impressions and decide whether there are more extensive keywords varieties that may attract more eyes.
              </li>
              <li><span className='font-bold'>Conversions:</span>We measure the number of people who have made a phone call or submitted a form to meet a key requirement to maintain the account, and to measure the amount of revenue or impact the campaign makes on your organization. </li>
            </ul>
            <p>It seems complicated. That is why; we are here. We can do this for you by using various relevant keyword tools to find more popular keywords for your nonprofit organization.</p>
            <p className='font-bold italic'>Still perplexed about whether you are eligible for the Google Ad Grants program? Don’t worry, give us a call, and we will answer all your questions that you might have regarding this amazing program.</p>
          </div>
        </div>
