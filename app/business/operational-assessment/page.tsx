      ...
      <div className='flex flex-col rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6  lg:grid-cols-2 gap-10 items-center justify-start'>
        ...
        <div className='flex flex-col lg:flex-row gap-8 lg:gap-20'>
          <div className='space-y-6'>
            ...
            <p>Do you know how much money organizations waste with their ineffective processes? Well, there isn’t an exact number but it is in billions of dollars!</p>
        ...
        <div className='space-y-6 '>
          ...
          <p>We would then be able to connect several proposed adjustments to the current processes and consequently discover the best solution.</p>
          <p>Our team is highly dedicated that can help you in improving the current situation.</p>
    ...
    <Image src={IMG3} alt="Operational Assessments" className='w-full h-auto object-cover' />
      ...
      <div className='rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6  lg:grid-cols-2 gap-10 items-center'>
          ...
          <ul className='list-decimal pl-5 space-y-6'>
            <li> <span className='font-bold'>Report Daily Results:</span> Let your employees know about past sales results. It will help them reach their maximum potential to outdo the level they achieved the previous day.</li>
            <li> <span className='font-bold'>Report KPIs Weekly:</span> By showing your staff the company’s KPI report weekly, they will know their key performance indicators, which will help them leverage their strength.</li>
            <li> <span className='font-bold'>Set Goals:</span>By setting goals, you are pushing your employees to further their careers and maximize profit. Set a goal just beyond yesterday’s results. Slowly, you will start to see an increase in your profitability.</li>
            <li> <span className='font-bold'>Set Individual Goals:</span> You can even set goals for individual employees and help them track their productivity. This will help you classify the areas that need work.</li>
