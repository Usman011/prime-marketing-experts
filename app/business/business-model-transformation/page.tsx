...
import IMG from '../../../public/images/Business-model-teansformation/image.png';
  ...
  return (
    <section>
      ...
      <div className='flex flex-col space-y-6 mt-10 mx-2 justify-start'>
        ...
        <p>
          We are glad to introduce the idea of creating a new business model with your needs in mind. We curate a business model that fits your company culture while embracing the digital economy era. Because it might not please you that business models that are stuck along the line of “this worked well in the good old days” are certainly obsolete now.
        </p>
        <p>
          It makes up beautiful nostalgic tales for your kids but surely cannot make through the future. The digitalization that we are surrounded with is the reason for rapidly evolving competition in business and ways to create value.
        </p>
        <p>
        ...
        <ul className='list-decimal pl-5 space-y-6'>
          <li>
            <span className='font-bold'>Strategy-informed ambition: </span>
            We define or translate strategic business goals into a bold and realistic ambition through our transformational services.
          </li>
          <li>
            <span className='font-bold'>Lead with aptitudes: </span>
            We know the importance of building discipline and regulations that establishes a new course that helps in keeping up with the pace of the disruptive business world.
          </li>
          <li>
            <span className='font-bold'>Drive for value: </span>
            Business model transformation is all about creating more value or money. So we take due time to know the value you intend to create, explicitly.
          </li>
          <li>
            <span className='font-bold'>Built-in sustainability:</span>
            We are an adaptive organization that clasps hold of new ways of delivering value to your business and hence to ours. Your growth is our growth!
          </li>
          <li>
            <span className='font-bold'>Agile and flexible:</span>
            While these two words define us, we also implement an agile approach that promises to deliver swift wins and iterative progress.
          </li>
        </ul>
        <p>
          At any scale, a cultural shift and having highly engaged leaders is necessary. They take control of the steering wheel of your organization. And we are the front foot, award-winning leaders.
        ...
        <ul className='list-disc pl-5 space-y-6'>
          <li>
            ...
            We take your consumers in due consideration, be it individuals and segments that are existing or potential buyers of the product or service.
          </li>
          <li>
            <span className='font-bold'>Customer value proposition:</span>
          ...
          <li>
            <span className='font-bold'>Essential Resources & Key Processes:</span>
