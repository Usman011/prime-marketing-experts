		...
		<section className="min-h-screen container px-2 md:px-12 lg:px-24">
			<div className="bg-gradient-to-r from-orange-50 to-red-50 py-8 md:py-16">
				<div className="container mx-auto px-4 max-w-4xl">
					...
					<p className="text-base md:text-lg text-gray-600 leading-relaxed md:leading-relaxed text-center max-w-2xl mx-auto">
						Grow your retail business with data-driven digital marketing strategies
					</p>
				</div>
			</div>
			<div className="container mt-10">
				...
				<div className="flex flex-col lg:flex-row items-center rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-2 md:p-6  justify-between mb-10 pb-10">
					...
					<div className="w-full lg:w-1/2 text:start md:text-center lg:text-left lg:pr-12 transform transition-all duration-500 hover:scale-105">
						...
						<p className="mt-6  text-gray-600">
							At Prime Marketing Experts, we understand that the retail industry is fast-paced and
							ever-changing. Whether you own a brick-and-mortar store, run an e-commerce shop, or
							manage a multi-location retail chain, we provide customized marketing strategies to
							help you stand out from the competition, boost sales, and build lasting customer
							relationships.
						</p>
				...
				<div className="bg-blue-50 my-10 py-10 p-0 md:p-6 rounded-lg shadow-lg">
					<h2 className="text-3xl md:text-4xl font-bold text-start  text-gray-800">
						Our Retail Marketing Strategies
					</h2>
					<div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						<div className="flex flex-col items-center p-2 md:p-6 bg-white rounded-lg shadow-md  transition-all">
							...
							/>
							<h3 className="text-xl font-semibold text-start md:text-center mt-4 text-gray-800">
								Social Media Engagement
							</h3>
							<p className="mt-2 text-gray-600 text:start md:text-center">
								Social media is an essential tool for connecting with your customers and promoting
								your retail products. We create dynamic social media strategies that highlight your
								products, seasonal promotions, and events while engaging your audience with
								compelling content. From Instagram shopping to Facebook campaigns, we ensure your
								retail brand is visible and appealing across the platforms your customers use most.
							</p>
						</div>
						<div className="flex flex-col items-center p-2 md:p-6 bg-gray-100 rounded-lg shadow-md hover:bg-gray-200 transition-all">
							...
							<p className="mt-2 text-gray-600 text-start">
								Search engine optimization (SEO) is key to ensuring that your retail business ranks
								highly on search engines and gets discovered by potential customers. Our SEO
								strategies are designed to increase organic traffic, improve product visibility, and
								drive sales both online and in-store. We optimize your website and product listings,
								ensuring that you appear in the right search results.
							</p>
						</div>
						<div className="flex flex-col items-center p-2 md:p-6 bg-gray-100 rounded-lg shadow-md hover:bg-gray-200 transition-all">
							<Image
							...
							<p className="mt-2 text-gray-600 text:start md:text-center">
								Paid advertising allows you to target your ideal customers and drive instant
								results. We design and manage targeted advertising campaigns on platforms like
								Google Ads, Facebook, Instagram, and more to increase visibility, boost product
								sales, and drive traffic to your store or website. With our data-driven approach, we
								ensure that every dollar you spend on advertising delivers measurable results.
							</p>
						</div>
					</div>
				</div>
					...
					<div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						<div className="bg-blue-50 p-2 md:p-6 rounded-lg shadow-lg">
							<p className="text-gray-600 italic">
								Prime Marketing Experts helped us increase our sales by 40% through their tailored
								digital marketing strategies. Highly recommend!
							</p>
						...
						<div className="bg-blue-50 p-2 md:p-6 rounded-lg shadow-lg">
							<p className="text-gray-600 italic">
								Their SEO and social media strategies have taken our online presence to new heights.
						...
						<div className="bg-blue-50 p-2 md:p-6 rounded-lg shadow-lg">
							<p className="text-gray-600 italic">
								Thanks to Prime Marketing Experts, our brand visibility has soared, and we`re seeing
								incredible foot traffic in our stores!
							</p>
					...
					<div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
						<div className="bg-white p-2 md:p-6 rounded-lg shadow-lg hover:bg-gray-50 transition-all">
							...
							<p className="mt-2 text-gray-600">
								We have a strong track record of driving measurable results for retail businesses by
						...
						<div className="bg-white p-2 md:p-6 rounded-lg shadow-lg hover:bg-gray-50 transition-all">
							...
							<p className="mt-2 text-gray-600">
								We don’t believe in one-size-fits-all solutions. Every retail business is unique,
								and we create custom marketing plans that align with your goals.
							</p>
						</div>
						<div className="bg-white p-2 md:p-6 rounded-lg shadow-lg hover:bg-gray-50 transition-all">
							<h3 className="text-xl font-semibold text-gray-800">Expert Team</h3>
							<p className="mt-2 text-gray-600">
								Our team of marketing professionals has extensive experience in the retail industry,
								ensuring that we understand the challenges you face and know how to overcome them.
							</p>
						</div>
						...
						<div className="bg-white p-2 md:p-6 rounded-lg shadow-lg hover:bg-gray-50 transition-all">
							...
							<p className="mt-2 text-gray-600">
								We offer around-the-clock support, ensuring that your marketing campaigns run
								smoothly and any questions are addressed promptly.
							</p>
						</div>
					</div>
				</div>
