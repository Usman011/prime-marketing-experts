...
<div className='flex justify-center sm:items-center lg:items-center md:pl-10 sm:pl-20 lg:ml-auto w-full h-52 flex-col text-center'>
      ...
      <div className="container mx-auto px-4 grid rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 py-10 my-10 p-6 grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        {/* Left Content */}
      ...
      <div className='flex flex-col space-y-6 bg-blue-50 py-10 my-10 p-6 '>
