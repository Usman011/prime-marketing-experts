    ...
    <section className="container  min-h-screen bg-gray-50 py-16">
      ...
      <div className="mx-auto ">
        ...
        <div className="py-16 bg-orange-600 text-white text-center rounded-lg shadow-xl">
          <h2 className="text-3xl font-semibold">Ready to Grow Your Cleaning Business?</h2>
          <p className="mt-4 text-lg">Contact us today to discuss how we can help your cleaning company reach more clients and increase your business growth.</p>
          <Link href="/contact" className="mt-6 px-6 py-3 text-white bg-orange-200 font-semibold rounded-md hover:bg-gray-100 transition-all">
            Get in Touch
          </Link>
        </div>
      </div>
