...
const Page = () => {
  return (
    <section className='container'>
      ...
      <div className='mx-2 gap-20 mt-10'>
        ...
        <div className='flex flex-col mx-2 space-y-8 justify-start'>
          ...
          <div className='flex flex-col lg:flex-row gap-8 lg:gap-20'>
            <div className='space-y-6'>
              <p>
                As a <Link href='/' className='text-blue-600'>top e-commerce Website Development Company</Link>, we help clients deliver exceptional online shopping experiences through providing website development, design, hosting, and maintenance services. We set up your online store, host & maintain it, and implement enhancements that help increase conversion.
              </p>
              <p>
              ...
              <p>
                Learn more about our digital marketing and advertising services for <Link href="/" className='text-blue-600'>E-Commerce businesses</Link>.
              </p>
            </div>
            <div className='w-full h-auto'>
