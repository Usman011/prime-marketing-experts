      ...
      <p className="text-lg text-gray-700 mb-4">
        ...
        <div className='flex flex-col bg-blue-50 p-6  gap-14'>
          ...
          <div className='space-y-6'>
            ...
            <p className='pl-14'>Chat bots have become a crucial element to deliver exceptional customer service with a very quick response effectively. We can integrate AI and NLP to provide an end-to-end solution to respond to routine customer requests in a humanoid fashion automatically. We may also develop buttons that direct visitors to areas of your website that are relevant to your request.</p> 
          </div>
          ...
          <div className='space-y-6'>
            ...
            <p className='pl-14'>Chat bots can be adapted to an e-commerce business. These provide exceptional customer service 24/7 by anticipating the needs of your users while offering to up sell and cross-sell solutions at key points in the buying cycle.</p> 
          </div>
          ...
          <div className='space-y-6'>
            ...
            <p className='pl-14'>Our chat bots anticipate user needs by providing recommendations based on past travel history. It also provides recommendations on what people should see based on nearby locations.</p> 
          </div>

          <div className='space-y-4'>
            <h1 className='text-3xl'>Simplified, Affordable Chat bots</h1>
            <p>We offer chat bots with the same functionality we have on our website for only $99 setup fee plus $99 per month! You can feel free to customize the platform to offer predetermined answers to common questions via integrated menus within your bot.</p>
          </div>
        </div>
        ...
        <div className='flex flex-col rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 space-y-6'>
          ...
          <div className='space-y-6'>
            <ul className='list-decimal pl-5 space-y-6'>
              <li><span className='font-bold'>Initiation:</span> This phase includes the study of the scope of work, commercial requirements, operational requirements, and technical requirements.</li>
              <li><span className='font-bold'>Project Analysis: </span>This phase requires a complete understanding of the key data for .net development, which includes the scope, deadlines, repetitive data, and the risks involved.</li>
              <li><span className='font-bold'>Team Development:</span>The right people for the right job are of paramount importance as they are the backbone of any development project. We do not leave any stone unturned to provide our best.</li>
              <li><span className='font-bold'>Commence The Project:</span>We value our customers’ time and our time. As such, no time is lost to start the project, once approved by all decision makers within your company.</li>
              <li><span className='font-bold'>Strict Delivery Schedules:</span>We maintain the transparency of the project status and respect strict delivery schedules. Our clients are well informed of the progress made at the various stages of project development.</li>  
            </ul>
          </div>
        </div>
        ...
        <div className='flex flex-col bg-blue-50 p-6 mb-8 gap-10'>
          ...
          <ul className='list-disc pl-5 space-y-2'>
            ...
            <li>We can interpret the messages of the users easily to offer a better solution for your queries.</li>
            <li>We don’t use our old chat bots. We make customized bots from scratch according to your preference, needs, and requirements. So, you can easily connect with your prospects in a more effective and efficient way.</li>
            <li>By developing chat bots to suit your preferences, we make sure that your users have a satisfied and content shopping experience.</li>
            <li>We take pride in delivering 24/7 attention to users and boost their experience on your website.</li>
            <p>So, contact us now for your chatbot development needs, and we will surely assist you!</p>
          </ul>
        </div>
      </div>
    </section>
