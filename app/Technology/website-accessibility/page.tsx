    ...
    <section className='container'>
      ...
      <div className='flex flex-col mx-2 gap-10 mt-10'>
        ...
        <div className='flex flex-col bg-blue-50 p-2 space-y-6 justify-start'>
          ...
          <div className='space-y-6'>
            <ul className='list-decimal pl-5 space-y-6'>
              <li><span className='font-bold'>Mechanical Assessment Tool:</span> This tool checks the website accessibility and goes through it to ensure that the website is obedient to the updates properly. It also checks out the things on your website that are not well-matched with the accessibility software.</li>
              <li><span className='font-bold'>Closed Captioning Services:</span> Most of the businesses select these services for those who are deaf or hearing disablement. This type of service covers the visual video content with appropriate captions recorded precisely with what is going on in the video so that it becomes easy to gather information.</li>
              <li><span className='font-bold'>Made-To-Order Options:</span> Best features of website accessibility are said to be good when it helps in saving our time, but some are not meant to be in the order of saving time. So, it is crucial to select the best-customized tools that can maintain the identity of your brand and the accessibility of your website correctly.</li>
              <li><span className='font-bold'>Color Combination:</span> For those who have problems watching the color, it is necessary to check the contrast of background and foreground color combinations. Such tools make sure that the colors of the website for site visitors are under the regulations of website accessibility.</li>
              <li><span className='font-bold'>Audio Acknowledgement:</span> This tool is made to use for the visually impaired person. This tool is available nowadays in many smartphones and computers. It helps such people to find a way of recognizing some aspects of the internet. It helps them to copy and paste the voice and go through the content on your website or fill out the forms they want through which they may get connected to you and become your customer quickly.</li>
              <li><span className='font-bold'>Screen Reader:</span> Website accessibility solutions can adjust a website to be fully compatible with screen reader tools. Such software allows the devices to translate the text on the screen into speech to assist blind individuals. It reads the captions and also learns the images of your webpage with the help of an alternate version with a proper idea of the content that is offered by your website.</li>
              <li><span className='font-bold'>Code Detector:</span> Detectors are used to create practice coding standards to put in force a definite coding average. It is used to read the codes of your website to search for some breakage in the codes that are not obedient to the rules and regulations.</li>
              <li><span className='font-bold'>Keyboard Navigation Optimization:</span> Some websites do not go along with the regulations of Keyboard navigation. Many people are not able to use the computers or any other tool through a touchpad or keyboard due to one or the other disablements. So to maintain the accessibility of your website this is also the necessary tool through which everybody can access through the website and collect information they want.</li>
            </ul>
          </div>
        </div>
        ...
        <div className='flex flex-col space-y-6 bg-blue-50 p-2 justify-start'>
          ...
          <div className='space-y-6'>
            <ul className='list-decimal pl-5 space-y-6'>
              <li><span className='font-bold'>Mechanical Assessment Tool:</span> Many systems may help to build the website through elements like editing toolbars and video players.</li>
              <li><span className='font-bold'>Use headings for the structural organization of your content:</span> Screen reader use heading structure to navigate content successfully and strategically, and the content will be well organized.</li>
              <li><span className='font-bold'>Include proper alt text for images:</span> Content on the website must include the related images so that it may become easy for the screen readers to translate those images into content easily.</li>
              <li><span className='font-bold'>Give your links unique and descriptive names:</span> Before providing the links, make sure that it describes that at what platform will that link takes the visitors.</li>
              <li><span className='font-bold'>Use color with care:</span> Color deficiency, red-green color deficiency, affects approximately 8% of the population, so make sure to take care of color contrast of your website.</li>
              <li><span className='font-bold'>Design your forms for accessibility:</span> Those who are using screen readers may not be able to correctly see the form provided on your website. So it is vital to check forms accessibility by using different tools.</li>
              <li><span className='font-bold'>Use tables for tabular data:</span> Using tables may distract the reader from the content. Use tables only if necessary and with the help of captions for rows and columns.</li>
              <li><span className='font-bold'>Ensure that all content can be reasonably accessed with the keyboard alone:</span> The tab order on your website must match the visual order so that the visitor who uses only keyboards can logically navigate through the content.</li>
              <li><span className='font-bold'>Use ARIA roles and landmarks (but only when necessary):</span> Accessible Rich Internet Application is a robust technical specification that is used for adding accessibility information to rudiments that are not natively available.</li>
              <li><span className='font-bold'>Make dynamic content accessible:</span> Screen readers may not be able to aware of the material that is updated without refreshing the page. Some software may help you to increase the accessibility of your website. This may also help the people who visit your website to gather information in accessing it properly.</li>
            </ul>
          </div>
        </div>
