				...
				<div className="container">
					<div className="max-w-[700px]">
						...
						<div className="mt-5 text-gray-200 ">
							We are a full service relationship-driven marketing firm. We craft connections, to
							drive results with integrated, customized solutions that maximize ROI for our clients.
							We are focused on serving Small and Medium size businesses that need quality and
							affordable marketing solutions to help them grow and compete effectively in today`s
