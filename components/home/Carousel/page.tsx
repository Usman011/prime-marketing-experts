...
export function CarouselSection() {
    return (
      <section className="bg-gray-100 container py-10 flex flex-col justify-center items-center  md:mt-auto mb-10 w-full h-auto">
        ...
        <Carousel className="container w-[90%] md:w-[85%]">
  <CarouselContent>
    <CarouselItem>
    <div className="flex flex-col md:flex-row items-center justify-center max-w-auto md:max-w-5xl mx-auto gap-7 md:mx-4 md:gap-10">
      {/* Left Side: Text */}
