		...
		<footer className="flex flex-col text-white bg-blue-950 border-t">
			<div className='flex flex-col lg:flex-row w-full gap-6 lg:gap-40 pt-10 px-4 lg:px-10'>
				...
				<div className='flex flex-col w-full lg:w-60 gap-4 lg:gap-6'>
					...
					<p className='text-xs md:text-sm lg:text-lg'><span className='font-bold'>Address:</span> 74 Northeastern Blvd #12a Ste 101 Nashua, NH 03062</p>
					<p className='text-xs md:text-sm lg:text-lg'><span className='font-bold'>Email:</span> hello@primemarketingexperts.com</p>
					<p className='text-xs md:text-sm lg:text-lg'><span className='font-bold'>Phone:</span> 617-651-1457</p>
			...
			<div className="flex flex-col lg:flex-row h-auto items-center justify-between mt-10 gap-4 lg:gap-40 border-t border-blue-500 py-4">
				<p className='text-xs md:text-sm text-center lg:text-left'>Terms of use | Privacy Environmental Policy</p>
				<p className='text-xs md:text-sm text-center lg:text-right'>Copyright © 2024 Prime Marketing Experts. All Rights Reserved.</p>
			</div>
		</footer>
	)
}
